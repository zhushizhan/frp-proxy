<template>
  ...
  >
    ...
    <PopoverMenuItem value="">{{ resolvedAllLabel }}</PopoverMenuItem>
    <PopoverMenuItem
...
const { t } = useI18n()
const resolvedAllLabel = computed(() => props.allLabel || t('common.all'))
...
const displayLabel = computed(() => {
  if (!props.modelValue) return resolvedAllLabel.value
