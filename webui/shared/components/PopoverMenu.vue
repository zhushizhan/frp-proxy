...
const inputPlaceholder = computed(() => {
  const fallbackPlaceholder = props.filterPlaceholder || t('common.searchEllipsis')
  if (isOpen.value) return fallbackPlaceholder
  if (!props.modelValue) return props.displayValue || fallbackPlaceholder
