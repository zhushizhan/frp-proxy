    ...
    <header class="header">
      <div class="header-content">
        <div class="brand-section">
          ...
          <span class="badge">{{ t('app.client') }}</span>
          <span class="badge badge-guided">{{ t('app.guidedUI') }}</span>
        </div>

        <div class="header-controls">
          <div class="locale-switch" :aria-label="t('app.language')">
            <button class="locale-btn" :class="{ active: locale === 'en' }" type="button" @click="setLocale('en')">
              EN
            </button>
            <button class="locale-btn" :class="{ active: locale === 'zh-CN' }" type="button" @click="setLocale('zh-CN')">
              中
            </button>
          </div>
          <a
...
.badge-guided {
  color: #1f2937;
  background: linear-gradient(135deg, #f5d0a9 0%, #fef3c7 100%);
}
