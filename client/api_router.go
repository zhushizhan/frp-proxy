...
func (svr *Service) registerRouteHandlers(helper *httppkg.RouterRegisterHelper) {
	...
	subRouter.HandleFunc("/api/settings", httppkg.MakeHTTPHandlerFunc(apiController.GetSettings)).Methods(http.MethodGet)
	subRouter.HandleFunc("/api/settings", httppkg.MakeHTTPHandlerFunc(apiController.UpdateSettings)).Methods(http.MethodPut)
	subRouter.HandleFunc("/api/files/upload", httppkg.MakeHTTPHandlerFunc(apiController.UploadFile)).Methods(http.MethodPost)
	...
	subRouter.HandleFunc("/api/config/proxies", httppkg.MakeHTTPHandlerFunc(apiController.ListConfigProxies)).Methods(http.MethodGet)
	subRouter.HandleFunc("/api/config/visitors", httppkg.MakeHTTPHandlerFunc(apiController.ListConfigVisitors)).Methods(http.MethodGet)
